...
const HowItWorks = () => {
  return (
    <section className='realative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto'>
      ...
      <div className='text-center mb-20'>
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10 backdrop-blur-sm mb-6">
          ...
          <span className='text-sm font-medium text-primary'>Simple Pocess</span>
        </div>
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Our streamlined process makes Medical care accessible, convenient, and stress-free for
          everyone
        </p>
      </div>
        ...
        <div className='grid lg:grid-cols-3 gap-12 lg:gap-8'>
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                Receive personalized recommendations based on thousands of medical cases. Our AI
